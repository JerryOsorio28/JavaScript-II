...
let fullName = runners.forEach (function (names){
...
let largeShirts = runners.filter (function (larges){
    if (larges.shirt_size === "L") {
      console.log (larges);
    }
});
...
let donationsSum = runners.reduce(function(acc, currentValue) {
